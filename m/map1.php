...
<div id="cont_wrap">
    ...
    <div class="top_h2 mb50"><p>진로로드맵</p></div>
    <div class="cont_size_type1">
        <ul class="admi_sisul clfl">
        	<li class="admi_sisul_on"><a href="map1.php" target="_self">위탁과정 후 진로(항공정비)</a></li>
        	<li class="admi_sisul_l"><a href="map2.php" target="_self">위탁과정 후 진로(항공관광)</a></li>
        </ul>
        <img class="mt50" src="./front/image/admissions/map/cont1.gif" alt="" />
    </div>
</div>
