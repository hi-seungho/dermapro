...
<div id="cont_wrap">
    ...
    <div class="top_h2 mb50"><p>공지사항</p></div>
    <div class="cont_size_type1">
        ...
        <div class="board_view_btns mt30 clfl">
            ...
            <a href="notice_list.php"><img style="margin: 0 0 5px 0;" src="./front/image/common/board/btn_b_list.gif" alt=""></a>
        </div>
    </div>
</div>
