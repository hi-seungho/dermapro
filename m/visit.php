...
<div id="cont_wrap">
    ...
    <div class="top_h2 mb50"><p>방문상담신청</p></div>
    <div class="cont_size_type1">
        <img class="mb50" src="./front/image/admissions/visit/cont1.jpg" alt="" />
        <div class="admi_2">
        ...
        <table class="table2" cellpadding="0" cellspacing="0">
            <tbody>
                ...
                <tr>
                    <th>지역</th>
                    <td>
                        <input type="radio" class="input_chk1"><label for="">인천</label>
                        <input type="radio" class="input_chk1"><label for="">경기</label>
                        <input type="radio" class="input_chk1"><label for="">서울</label>
                        <input type="radio" class="input_chk1"><label for="">기타</label>
                    </td>
                </tr>
                <tr>
                    <th>학교</th>
                    <td>
                        <input type="text" class="input_text3" size="5"><span>학교</span>
                ...
                <tr>
                    <th>문의사항</th>
                    <td><textarea name="name" class="textarea1"></textarea></td>
                </tr>
                <tr>
