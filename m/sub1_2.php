...
<div id="cont_wrap">
    ...
    <div class="cont_size_type1">
        <ul class="admi_sisul2 clfl">
            ...
            <li class="admi_sisul2_on"><a href="sub1_2.php" target="_self">내일배움카드제</a></li>
            <li class="admi_sisul2_l"><a href="sub1_3.php" target="_self">취업성공패키지 (Ⅰ.Ⅱ)</a></li>
        </ul>
        <img class="mt50" src="./front/image/process/sub1_2/cont1.jpg" alt="" />
    </div>
</div>
