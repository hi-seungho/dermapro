    ...
    <section id="anc_cf_basic">
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    <th scope="row"><label for="cf_1_subj">E-브로셔<strong class="sound_only">필수</strong></label></th>
                    <td colspan="3">
                        <input type="file" name="cf_1_subj" id="cf_1_subj" class="frm_input" size="40">
                        <?php if($config['cf_1']) { ?>
                            <input type="hidden" name="cf_1" value="<?php echo $config['cf_1']; ?>" id="cf_1">
                            <input type="checkbox" id="cf_1_subj_del" name="cf_1_subj_del" value="1"> <label for="cf_1_subj_del"><?php echo $config['cf_1_subj'];  ?> 파일 삭제</label>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="cf_2_subj">E-Brochure<strong class="sound_only">필수</strong></label></th>
                    <td colspan="3">
                        <input type="file" name="cf_2_subj" id="cf_2_subj" class="frm_input" size="40">
                        <?php if($config['cf_2']) { ?>
                            <input type="hidden" name="cf_2" value="<?php echo $config['cf_2']; ?>" id="cf_2">
                            <input type="checkbox" id="cf_2_subj_del" name="cf_2_subj_del" value="1"> <label for="cf_2_subj_del"><?php echo $config['cf_2_subj'];  ?> 파일 삭제</label>
                        <?php } ?>
                    </td>
                </tr>
    ...
    <section id="anc_cf_join">
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tr>
                    <th scope="row"><label for="cf_prohibit_id">아이디 금지단어</label></th>
                    <td>
                        <?php echo help('회원아이디으로 사용할 수 없는 단어를 정합니다. 쉼표 (,) 로 구분') ?>
