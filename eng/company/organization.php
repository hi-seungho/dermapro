...
?>
	...
	<div class="bread">
		<div class="home">
			<span class="ls0">HOME</span> <span>&gt;</span> Dermapro <span>&gt;</span> <span class="bold">Organization</span>
		</div>
	</div>
	...
	<div id="container">
		<div class="con mb0">
			...
			<img src="<?php echo G5_LANG_IMG_URL; ?>/sub/img_organization.jpg" alt="조직도 DERMAPRO">
		</div>
	</div><!-- container -->
<?php
