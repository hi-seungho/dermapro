...
?>
	...
	<div class="bread">
		<div class="home">
			<span class="ls0">HOME</span> <span>&gt;</span> News Center <span>&gt;</span> <span class="bold">Dermapro Academy</span>
		</div>
	</div>

	<ul class="sub_top_menu four">
		<li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=news_eng">Dermapro News</a></li>
		<li class="on"><a href="<?php echo G5_LANG_URL; ?>/news/paper_patent.php">Dermapro Academy</a></li>
		<?php if ($config['cf_2']) { ?>
			<li><a href="<?php echo G5_DATA_URL; ?>/file/config/<?php echo $config['cf_2']; ?>" target="_blank">E-Brochure</a></li>
		<?php } ?>
		<li><a href="agency.php">Related orgarnizations</a></li>
	</ul>
	<div id="container">
		<div class="con">
			<div class="tit_bg">
				<h3>Dermapro Academy</h3>
			</div>
			<div class="paper">
				<div class="comm-desc">
					<p class="ti-tit">
