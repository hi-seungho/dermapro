...
<h1 id="Logo">
	<a href="../../index.php"><img src="<?php echo G5_LANG_IMG_URL; ?>/main/logo.gif" alt="DERMAPRO"></a>
</h1>
<?include"../../include/gnb.php" ?>
	...
	<ul class="sub_top_menu three">
		<li class="on"><a href="recruitment_list.php">Recruitment Notice</a></li>
		<li><a href="precautions.php">Precautions</a></li>
		<li><a href="step.php">Procedure</a></li>
	</ul>
	<div id="container">
		<div class="con">
			<div class="tit_bg">
			...
			<div class="news recruit">
		                    ...
		                    <table>
		                        ...
		                        <tr>
		                           ...
		                           <!--  <th scope="col">
		                            ...
		                            <th scope="col"><a href="#">VIEWS</a></th>
		        ...
		        <nav class="pg_wrap">
		            <span class="pg">
		                <a href="#1" class="pg_page pg_start"><<</a>
		                <a href="#1" class="pg_page pg_prev"><</a>
		                ...
		                <a href="#10" class="pg_page pg_next">></a>
		                <a href="#10" class="pg_page pg_end">>></a>
		            </span>
		        </nav>
