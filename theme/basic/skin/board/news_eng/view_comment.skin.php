...
<section id="bo_vc">
    ...
    <?php } ?>
    <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty">No Data.</p><?php } ?>
...
<aside id="bo_vc_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_secret">Secret</label></th>
    ...
    <div class="btn_confirm">
        <input type="submit" id="btn_submit" class="btn_submit" value="Complete">
    </div>
