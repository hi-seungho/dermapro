...
<div id="sub_top05">
    <div class="sub_tit">
        <img src="<?php echo G5_LANG_IMG_URL; ?>/sub/img_subtop0505tit.png" alt="Participate">
    </div>
</div>
<div class="bread">
    <div class="home">
        <span class="ls0">HOME</span> <span>&gt;</span> Volunteers <span>&gt;</span> <span class="bold">Recruitment Notice</span>
    </div>
</div>

<ul class="sub_top_menu three">
    <li class="on"><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=recruitment_eng">Recruitment Notice</a></li>
    <li><a href="<?php echo G5_LANG_URL; ?>/examine/precautions.php">Precautions</a></li>
    <li><a href="<?php echo G5_LANG_URL; ?>/examine/step.php">Procedure</a></li>
</ul>
<div id="container">
    <div class="con">
        <div class="tit_bg">
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_homepage) { ?>
        <tr>
            <th scope="row"><label for="wr_homepage">Hompage</label></th>
        ...
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">Category<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="wr_subject">Subject<strong class="sound_only">필수</strong></label></th>
            <td>
    ...
    <div class="btn_confirm">
        <input type="submit" value="completed" id="btn_submit" accesskey="s" class="btn_submit">
