...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        writer <strong><?php echo $view['mb_id'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
        <span class="sound_only">작성일</span><strong><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
        hit<strong><?php echo number_format($view['wr_hit']) ?></strong>
        ...
        for ($i=0; $i<count($view['file']); $i++) {
         ...
         ?>
            <li>
                ...
                <span class="bo_v_file_cnt">Download Count: <?php echo $view['file'][$i]['download'] ?></span>
        ...
        for ($i=1; $i<=count($view['link']); $i++) {
         ...
         ?>
            <li>
                ...
                <span class="bo_v_link_cnt">Link Count: <?php echo $view['link_hit'][$i] ?></span>
            </li>
        <?php
            }
        }
