...
<div class="bread">
    <div class="home">
        <span class="ls0">HOME</span> <span>&gt;</span> News Center <span>&gt;</span> <span class="bold">Related orgarnizations</span>
    </div>
</div>

<ul class="sub_top_menu four">
    <li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=news_eng">Dermapro News</a></li>
    ...
    <?php } ?>
    <li class="on"><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=agency_eng">Related orgarnizations</a></li>
</ul>
<div id="container">
    <div class="con">
        <div class="tit_bg">
            <h3>Related orgarnizations</h3>
        </div>
        <div class="agency">
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php
        //if ($bo_table == 'mailling') $is_link = false;
        for ($i=1; $is_link && $i<=1; $i++) { ?>
            <tr>
        ...
        <?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
            <tr>
                <?php if($i == 0) { ?>
                    <th scope="row"><?php echo 'Thumbnail <br> ('.$board['bo_gallery_width'].'px X '.$board['bo_gallery_height'].'px)'; ?></th>
                <?php } else { ?>
                    <th scope="row">File #<?php echo $i ?></th>
                <?php } ?>
                <td>
